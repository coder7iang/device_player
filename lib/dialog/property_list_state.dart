...
class PropertyListState {
  ...
  bool operator ==(Object other) {
    ...
    return other is PropertyListState &&
  ...
  @override
  String toString() {
    return 'PropertyListState(selectorList: $selectorList, dataList: $dataList, current: $current, isShowSystemApp: $isShowSystemApp, isLoading: $isLoading)';
  }
}
